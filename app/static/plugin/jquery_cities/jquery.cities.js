...
;(function($, window, document, undefined) {
    $.fn.citys = function(parameter,getApi) {
        ...
        var defaults = {
            dataUrl:'static/plugin/jquery_cities/cities.json',    //数据库地址
            ...
            $.getJSON(options.dataUrl,function(data){
                ...
                var format = {
                    province:function(){
                        $province.empty();
                        if(!options.required){
                            $province.append('<option value="0"> - 请选择 - </options>');
                            options.province = 0;
                        }
                        for(i in province){
                    ...
                    city:function(){
                        $city.empty();
                        if(!options.required){
                            $city.append('<option value="0"> - 请选择 - </options>');
                        }
                    ...
                    area:function(){
                        $area.empty();
                        if(!options.required){
                            $area.append('<option value="0"> - 请选择 - </options>');
                        }
                        if(options.nodata=='disabled'){
